...
public class EJ_4_Chat_ClienteChat extends JFrame implements ActionListener, Runnable {
	...
	// constructor
	public EJ_4_Chat_ClienteChat(Socket s, String nombre) {
	...
	public static void main(String args[]) {
		...
		try {
			...
			EJ_4_Chat_ClienteChat cliente = new EJ_4_Chat_ClienteChat(s, nombre);
