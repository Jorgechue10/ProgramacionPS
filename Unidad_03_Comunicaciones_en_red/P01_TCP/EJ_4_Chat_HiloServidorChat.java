...
public class EJ_4_Chat_HiloServidorChat implements Runnable {
	DataInputStream fentrada;
	Socket socket = null;
	EJ_4_Chat_ComunHilos comun;

	public EJ_4_Chat_HiloServidorChat(Socket s, EJ_4_Chat_ComunHilos comun) {
		this.socket = s;
		this.comun = comun;
		try {
