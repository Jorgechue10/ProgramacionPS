...
public class EJ_4_Servidor_Objetos {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		/* 
		 * En cambio, para los datos recibidos (bytes) por el datagrama en un objeto Persona 
		...
		*/
		...
		socket.receive(paqRecibido);//Datagrama recibido
		...
		EJ_4_0_Persona persona = (EJ_4_0_Persona)in.readObject(); //Se obtiene el objeto recibido como bytes
		in.close();		
