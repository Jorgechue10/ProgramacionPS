...
public class EJ_06_Chat_TCP_ClienteChat extends JFrame implements ActionListener, Runnable {
	...
	// constructor
	public EJ_06_Chat_TCP_ClienteChat(Socket s, String nombre) {
	...
	public static void main(String args[]) {
		...
		try {
			...
			EJ_06_Chat_TCP_ClienteChat cliente = new EJ_06_Chat_TCP_ClienteChat(s, nombre);
